...
class DimensionRef extends Ref {
...
type SqlDef = ColumnRef | SqlWithRefs;

type SqlFn<DN extends string = string> = (args: {
  table: {
...
class Dimension extends Member {
  constructor(
    public readonly table: AnyTable,
    public readonly name: string,
